...
public class CustomerService {
    ...
    public static Customer getCustomerByPhone(String phoneNumber) throws Exception{
        ...
        String formattedPhoneNumber = PhoneUtil.getFormattedPhone(phoneNumber);//ex: 801-719-0908 becomes +18017190908
    ...
    public static String createCustomer(Customer newCustomer, boolean update) throws Exception{
        String phone = PhoneUtil.getFormattedPhone(newCustomer.getPhone());//ex: 801-719-0908 becomes: +18017190908
